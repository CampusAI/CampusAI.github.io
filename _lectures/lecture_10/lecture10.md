...
**Algorithm:**
{% include figure.html url="/_lectures/lecture_10/mcts_algo.png" %}
...
{% include figure.html url="/_lectures/lecture_10/lq.png" description="Linear $f$, quadratic $c$ formulation." %}
...
{% include figure.html url="/_lectures/lecture_10/linear_lqr.png" description="Linear LQR algorithm." %}
...
{% include figure.html url="/_lectures/lecture_10/ilqr.png" description="Non-linear case approximation." %}
